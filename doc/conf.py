...
htmlhelp_basename = 'miros-rabbitmq-doc'
...
latex_documents = [
    (master_doc, 'miros-rabbitmq.tex', 'miros-rabbitmq Documentation',
     'Scott Volk', 'manual'),
]
...
man_pages = [
    (master_doc, 'miros-rabbitmq', 'miros-rabbitmq Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'miros-rabbitmq', 'miros-rabbitmq Documentation',
     author, 'miros-rabbitmq', 'network plugin for miros',
     'Miscellaneous'),
]
